...
app.use(cors("﹡")); //Enables use of CORS - ﹡ means every domain is now allowed to this server to send data - not secure - * is for development
...
app.get("/api/tasks", async (req, res) => {
    try {
        ...
        if (sortBy === "dueDate") {
            sortOption = { dueDate: 1 } // 1 is ascending, -1 is decending
